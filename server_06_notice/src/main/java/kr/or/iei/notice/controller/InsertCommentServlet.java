...
public class InsertCommentServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//다시 상세보기 화면이 브라우저에 보여지도록
		//ViewServlet에 요청하며, 상세 정보를 표출할 게시글 번호(noticeNo) 전달.
		//updChk는 false로 전달하여 조회수 업데이트 되지 않도록 처리
		request.setAttribute("loc", "/notice/view?noticeNo=" + noticeRef + "&updChk=false");
