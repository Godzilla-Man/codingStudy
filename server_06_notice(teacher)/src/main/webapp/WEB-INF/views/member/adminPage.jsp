...
<body>
		...
		<main class="content">
			<section class="section admin-wrap">
				...
				<table class="tbl tbl-hover">
					...
					<tr>
						<td colspan="10">
							<button class="btn-point lg" onclick="chgAllLevel()">선택 회원 등급변경</button>
						</td>
					</tr>
				</table>
			</section>
	...
	//선택 회원 등급변경 버튼 클릭 시, 동작 함수
	function chgAllLevel(){
		/* 서블릿으로 등급 변경 요청 시, 전달 데이터 형식
			
		   회원번호 :  '2505070021/2505080022'
		   등급변경 :  '2/3'
		*/
		
		//체크된 행의 회원번호와, 변경등급값을 각각의 배열에 삽입
		
		let chkMember = $('.chk:checked'); //체크된 체크박스's
